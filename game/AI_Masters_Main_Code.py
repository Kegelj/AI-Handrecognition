...
import time
import math
from live_app.overlay import ArrowOverlay as utils
...
class Goat:
    ...
    def load_img(self):
        try:
            self.image = pygame.image.load('game/goat.png').convert_alpha()
...
class Squirrel:
    ...
    def load_img(self):
        try:
            self.image = pygame.image.load('game/squirrel.png').convert_alpha()
...
class Player:
    def __init__(self):
        self.gun_visible = True # False original
        self.pos = [400, 400]
        self.radius = 40
        self.gravity = 0
        self.jump_power = 20
        ...
        self.health = 50 #100 original - 50= 2 hits
        self.max_health = 50 #100 original
        self.ammo = 50 # 5 Original
    ...
    def load_images(self):
        try:
            self.image = pygame.image.load('game/zelda.png').convert_alpha()
...
class Game:
    def __init__(self):
        ...
        self.setup_audio()
        self.goats_killed = 0
        self.overlay = utils.ArrowOverlay(WIDTH,HEIGHT)
    ...
    def load_assets(self):
        # Load bullet image
        try:
            self.bullet_img = pygame.image.load('game/bullet.png').convert_alpha()
        ...
        # Load gun image 
        try:
            self.gun_img = pygame.image.load('game/gun.png').convert_alpha()
        ...
        # Load background
        try:
            self.ground = pygame.transform.scale(pygame.image.load('game/ground.png').convert_alpha(), (WIDTH, HEIGHT // 2))
            self.sky = pygame.transform.scale(pygame.image.load('game/sky.jpeg').convert_alpha(), (WIDTH, HEIGHT))
        except:
    ...
    def setup_audio(self):
        try:
            pygame.mixer.music.load("game/Game.mp3.mp3")
            pygame.mixer.music.set_volume(0.7)
            pygame.mixer.music.play(-1)
            self.gun_toggle_sound = pygame.mixer.Sound("game/reload.mp3")  
