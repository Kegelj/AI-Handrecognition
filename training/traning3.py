...
# Manuelles Training mit Evaluation pro Epoche
for epoch in range(EPOCHS):
    ...
    # Bestes Modell nach Accuracy speichern
    if acc > best_acc:
        best_acc = acc
        model.save("model_output/best_model_by_iou.h5")
        print(f"💾 Neues bestes Modell gespeichert mit IoU Accuracy: {acc:.2%}")
